      ...
      <div class="card-deck mb-3 text-center">
        <div class="card mb-4 box-shadow">
          ...
          <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
              <li>Get the details of the patient to register them with this functional software.</li>

            </ul>
            <a style="text-decoration:none" href = "register_patient.php"><button type="button" class="btn btn-lg btn-block btn-primary">Register</button></a>
          </div>
        </div>
		...
		<div class="card mb-4 box-shadow">
          ...
          <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
              <li>You can view the past records from here.<br>(Patient verification compulsory)</li>
            </ul>
